...
View.prototype.exercise4 = function () {
  ...
  $('.square:nth-child(odd)').text('jonathan');
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $('.square').on('click', function (element) {
    let pos = $(element.currentTarget).data('pos');
    alert(pos);
  });
};
...
View.prototype.exercise6 = function () {
  ...
  $('.square').each(function (_, element) {
    let $sq = $(element);
...
View.prototype.exercise7 = function(){
  ...
  //your code here!
  $(".square").mouseenter(function(element) {
    let color = $(element.currentTarget).css("background-color");
    console.log(color);
  });
};
